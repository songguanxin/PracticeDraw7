    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PropertyValuesHolder propertyValuesHolder1 = PropertyValuesHolder.ofFloat("scaleY",0,1);
                PropertyValuesHolder propertyValuesHolder2 = PropertyValuesHolder.ofFloat("alpha",0,1);

                ObjectAnimator objectAnimator = ObjectAnimator.ofPropertyValuesHolder(view,propertyValuesHolder,propertyValuesHolder1,propertyValuesHolder2);
